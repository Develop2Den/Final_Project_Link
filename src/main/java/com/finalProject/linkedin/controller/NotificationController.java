...
public class NotificationController {
    ...
    @Operation(summary = "Get paginated notifications", description = "Get list of notifications with pagination")
    ...
    public List<NotificationRes> getAllNotification(
        ...
        log.info("Pageable request notifications: page={}, size={}", page, size);
